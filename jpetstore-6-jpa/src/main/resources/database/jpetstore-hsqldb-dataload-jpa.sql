...
INSERT INTO account(userid, version, email, firstname, lastname, status, addr1,
  ...
  VALUES('j2ee', 0, 'brodriguez@planet-express.earth','Bender', 'Rodriguez', 'OK', '901 San Antonio Road',
    'MS UCUP02-555', 'Palo Alto', 'CA', '94303', 'USA',  '555-555-5555', 'DOGS');
INSERT INTO account(userid, version, email, firstname, lastname, status, addr1,
    addr2, city, state, zip, country, phone, favcategory)
  VALUES('ACID', 0, 'acid@yourdomain.com','ABC', 'XYX', 'OK', '901 San Antonio Road',
    'MS UCUP02-777', 'Palo Alto', 'CA', '94303', 'USA',  '777-777-7777', 'CATS');
...
INSERT INTO supplier(suppid, version, name, status, addr1, addr2, city, state, zip, phone)
  VALUES (2,0,'ABC Pets','AC','700 Abalone Way','','San Francisco ','CA','94024','415-947-0797');
...
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FI-SW-01','FISH','Angelfish','<image src="../images/fish1.gif">Salt Water fish from Australia');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FI-SW-02','FISH','Tiger Shark','<image src="../images/fish4.gif">Salt Water fish from Australia');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FI-FW-01','FISH', 'Koi','<image src="../images/fish3.gif">Fresh Water fish from Japan');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FI-FW-02','FISH', 'Goldfish','<image src="../images/fish2.gif">Fresh Water fish from China');
...
INSERT INTO product(productid, categoryid, name, descn) VALUES ('K9-PO-02','DOGS','Poodle','<image src="../images/dog6.gif">Cute dog from France');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('K9-DL-01','DOGS', 'Dalmation','<image src="../images/dog5.gif">Great dog for a Fire Station');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('K9-RT-01','DOGS', 'Golden Retriever','<image src="../images/dog1.gif">Great family dog');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('K9-RT-02','DOGS', 'Labrador Retriever','<image src="../images/dog5.gif">Great hunting dog');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('K9-CW-01','DOGS', 'Chihuahua','<image src="../images/dog4.gif">Great companion dog');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('RP-SN-01','REPTILES','Rattlesnake','<image src="../images/snake1.gif">Doubles as a watch dog');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('RP-LI-02','REPTILES','Iguana','<image src="../images/lizard1.gif">Friendly green friend');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FL-DSH-01','CATS','Manx','<image src="../images/cat2.gif">Great for reducing mouse populations');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('FL-DLH-02','CATS','Persian','<image src="../images/cat1.gif">Friendly house cat, doubles as a princess');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('AV-CB-01','BIRDS','Amazon Parrot','<image src="../images/bird2.gif">Great companion for up to 75 years');
INSERT INTO product(productid, categoryid, name, descn) VALUES ('AV-SB-02','BIRDS','Finch','<image src="../images/bird1.gif">Great stress reliever');
