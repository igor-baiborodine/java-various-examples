...
public class BookDaoTest {
    ...
    private void insertBook(Book book) {
        collection.insert(Utils.convertPOJOtoDBObject(book));
    ...
    public void update_shouldReturnOptionalPresentForExistingIsbn() {
        ...
        DBObject dbObject = collection.findOne(Utils.convertPOJOtoDBObject(book));
        Book updatedBook = (Book) Utils.convertDBObjectToPOJO(dbObject, Book.class);
